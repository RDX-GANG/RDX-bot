...
OFFICIAL_UPSTREAM_REPO = "https://github.com/RDX-GANG/RDX-bot/"
BOT_IS_UP_TO_DATE = "❂🔱╚»★𝐑𝐃𝐗bot★«╝🔱 is on its latest build!❂"
NEW_BOT_UP_DATE_FOUND = (
    "🔱╚»★𝐑𝐃𝐗bot★«╝🔱 Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def updater(message):
    ...
    if not changelog:
        await message.edit(
            "*✇Updating✇ 🔱╚»★𝐑𝐃𝐗bot★«╝🔱 \n**✮Version✮** : `1.0` \n**🔱ᴛᴇʟᴇᴛʜᴏɴ🔱** : `6.0.9` \n**⚠️ᴄᴜʀʀᴇɴᴛ ʙʀᴀɴᴄʜ⚠️** : `↼🄼🄰🅂🅃🄴🅁⇀` \n**🛡️𝖘𝖙𝖆𝖙𝖚𝖘🛡️** : `«Pulling Updates»` \n『**Thank You For Using this BHARMAND CHODNE WALA BOT !**』"
        )
