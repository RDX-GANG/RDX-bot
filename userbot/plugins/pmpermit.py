...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/90015e33395f6196486ee.gif"
else:
...
USER_BOT_WARN_ZERO = "`You were spamming my Boss's inbox, henceforth your retarded lame ass has been blocked by my master's 🔱╚»★𝐑𝐃𝐗bot★«╝🔱.` "
USER_BOT_NO_WARN = ("`Hello ! This is` 🔱╚»★𝐑𝐃𝐗bot★«╝🔱\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(1078443722,1343556834,554048138)))
